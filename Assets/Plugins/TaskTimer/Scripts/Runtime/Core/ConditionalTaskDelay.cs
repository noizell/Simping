...
namespace NPP.TaskTimers
{
    public class ConditionalTaskDelay : TaskDelay
    {
        ...
        public ConditionalTaskDelay(float delay, System.Func<bool> condition, System.Action onConditionTrue, System.Action<int> onEachInterval, TaskDelayManager taskDelayManager)
        {
            Delay = delay;
            Condition = condition;
